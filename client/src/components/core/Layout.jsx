    ...
    <div>
        ...
        <header className="lg:ms-[260px] fixed top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
          ...
          >
            <div className="xl:col-span-1 flex items-center md:gap-x-3">
              ...
              {/* End Sidebar Toggle */}
              {/* Search Input */}
              <div className="hidden lg:block min-w-[20rem] xl:w-full">
                        ...
                        <ul className="divide-y divide-gray-200 dark:divide-neutral-800">
                          ...
                          <li className="relative group w-full flex gap-x-5 text-start p-5 bg-gray-100 dark:bg-neutral-800">
                            <div className="relative flex-shrink-0">
                              ...
                              />
                              <span className="absolute top-4 -start-3 w-2 h-2 bg-blue-600 rounded-full dark:bg-blue-500" />
                            </div>
                            <div className="grow">
                          ...
                          <li className="relative group w-full flex gap-x-5 text-start p-5">
                            ...
                            <div className="grow">
                              ...
                              <p className="text-sm text-gray-500 dark:text-neutral-500">
                                Add yourself to our new “Hire Page”. Let
                                visitors know you’re open to freelance or
                                full-time work.
                              </p>
                              <a
                          ...
                          <li className="relative group w-full flex gap-x-5 text-start p-5">
                            ...
                            <div className="grow">
                              ...
                              <p className="text-sm text-gray-800 dark:text-neutral-400">
                                We’re updating our Privacy Policy as of 10th
                                January 2023
                              </p>
                              <p>
                                <a
        ...
        >
          <div className="flex flex-col h-full max-h-full py-3">
            {/* Header */}
            <header className="px-8 h-[46px] text-center">
              {/* Logo */}
              <a
                className="flex-none rounded-md text-xl inline-block focus:outline-none focus:opacity-80 text-blue-700 font-bold font-mono"
                href="#"
                aria-label="Jimmy"
              >
                Front-Back
                ...
                <ul>
                  ...
                  <li className="px-5 mb-0.5">
                    <a
                      ...
                      href="#"
                    >
                      <span className="flex justify-center items-center w-6 h-6 bg-blue-600 text-white rounded-md dark:bg-blue-500">
                        <svg
            ...
            <footer className="hidden lg:block absolute bottom-0 inset-x-0 border-t border-gray-200 dark:border-neutral-700">
              ...
              <div className="hs-dropdown relative flex [--auto-close:inside]">
                ...
                <button
                  id="hs-pro-dnwpd"
                  type="button"
                  className="w-full inline-flex items-center py-3 px-7 text-start text-gray-800 align-middle disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-white dark:focus:bg-neutral-700"
                >
                  <svg
                  ...
                  <svg
                    className="flex-shrink-0 w-3.5 h-3.5 ms-auto"
                    xmlns="http://www.w3.org/2000/svg"
                    width={24}
                    height={24}
                    viewBox="0 0 24 24"
        ...
        {/* ========== END MAIN CONTENT ========== */}
        {/* ========== FOOTER ========== */}
        <footer className="lg:ps-[260px] absolute bottom-0 inset-x-0 h-[40px] sm:h-[64px]">
        ...
        <div
          id="hs-pro-dnam"
          className="hs-overlay hs-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform h-full w-full sm:w-[400px] z-[80] flex flex-col bg-white border-s hidden dark:bg-neutral-800 dark:border-neutral-700 dark:hs-overlay-backdrop-open:bg-neutral-900/90"
          tabIndex={-1}
        >
          {/* Header */}
            ...
            <div className="max-h-full w-full flex flex-col bg-white rounded-xl pointer-events-auto shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-800 dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)]">
              ...
              <div className="p-4 border-b border-gray-200 dark:border-neutral-700">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="py-2 ps-7 pe-20 block w-full text-gray-800 bg-transparent border-transparent rounded-lg text-sm focus:z-10 focus:outline-none focus:border-transparent focus:ring-0 placeholder:text-gray-500 disabled:placeholder:text-neutral-600 dark:text-white dark:placeholder:text-neutral-500"
                    placeholder="Search keyboard or shortcuts"
                  />
                  <div className="absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 dark:border-neutral-700 dark:text-neutral-200">
                    <span className="min-h-[30px] inline-flex justify-center items-center py-0.5 px-1.5 bg-white border border-gray-200 font-mono text-sm text-gray-600 rounded-md dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                      Cmd + K
                    </span>
                  </div>
                </div>
              ...
              {/* End Search Input */}
              {/* Body */}
              <div className="h-[550px] overflow-y-auto overflow-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-800">
                <div className="p-4 space-y-5">
                  <div>
                    <h4 className="text-gray-800 font-semibold mb-2.5 dark:text-neutral-200">
                      Formatting
                    </h4>
                    {/* List */}
                    <ul>
                      <li className="flex justify-between items-center gap-x-2 py-2.5 border-t border-gray-200 text-gray-800 dark:border-neutral-700 dark:text-neutral-300">
                        <span className="font-bold">Bold</span>
                        <div className="flex gap-x-1">
                          <span className="min-h-[30px] inline-flex justify-center items-center py-1 px-1.5 bg-white border border-gray-200 font-mono text-sm text-gray-800 rounded-md dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200">
                            Ctrl
                          </span>
                          +
                          <span className="min-h-[30px] inline-flex justify-center items-center py-1 px-1.5 bg-white border border-gray-200 font-mono text-sm text-gray-800 rounded-md dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200">
                    ...
                    <ul>
                      <li className="flex justify-between items-center gap-x-2 py-2.5 border-t border-gray-200 text-gray-800 dark:border-neutral-700 dark:text-neutral-300">
                        <span>
                          Mention person
                          <a
                            className="font-semibold text-sm text-blue-600 decoration-2 hover:underline focus:underline dark:text-white dark:hover:text-white/80"
                            href="#"
                          >
                            (@Brian)
                          </a>
